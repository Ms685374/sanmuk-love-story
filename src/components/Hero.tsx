      ...
      >
        ...
        <div className="relative">
          ...
          {[0, 1, 2, 3].map((i) => (
            <motion.div
              key={`ghost-${i}`}
              className="font-display text-[18vw] md:text-[15vw] font-bold leading-[0.85] tracking-[-0.02em] text-outline opacity-[0.08]"
          ...
          {/* Main title */}
          <motion.h1
            className="font-display text-[18vw] md:text-[15vw] font-bold leading-[0.85] tracking-[-0.02em] text-foreground relative"
            initial={{ opacity: 0, y: 100 }}
        ...
        <div className="relative mt-4">
          {[0, 1, 2].map((i) => (
            <motion.p
              key={`sub-ghost-${i}`}
              className="font-display text-[5vw] md:text-[3.5vw] italic text-outline-thin opacity-[0.06]"
