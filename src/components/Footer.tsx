...
const Footer = () => {
  return <footer className="relative py-24 md:py-32 px-6 md:px-12 border-t border-border">
      {/* Large background text */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none flex items-center justify-center">
        <motion.p className="font-display text-[25vw] font-bold text-foreground/[0.02] whitespace-nowrap" initial={{
        opacity: 0
      }} whileInView={{
        opacity: 1
      }} viewport={{
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
          ...
          duration: 0.6
            ...
            <ul className="space-y-3 font-body text-sm text-foreground/70">
              <li>Together since November 2024</li>
          ...
          duration: 0.6
            ...
            <p className="font-body text-sm text-foreground/70 leading-relaxed mb-4">
              This was made with all my love for you, zubi. You're my favorite notification and my forever home.
            </p>
        ...
        {/* Bottom bar */}
        <motion.div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4" initial={{
        opacity: 0
      }} whileInView={{
        opacity: 1
      }} viewport={{
