  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in-slow": "fade-in-slow 2s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        ...
        "bounce-soft": "bounce-soft 4s cubic-bezier(0.16, 1, 0.3, 1) infinite",
        "shimmer": "shimmer 4s cubic-bezier(0.16, 1, 0.3, 1) infinite",
        "expand": "expand 1.8s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "float": "float 6s cubic-bezier(0.16, 1, 0.3, 1) infinite",
        "glow-pulse": "glow-pulse 3s cubic-bezier(0.16, 1, 0.3, 1) infinite",
      },
    },
  },
